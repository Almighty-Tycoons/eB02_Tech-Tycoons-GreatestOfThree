...
<u> <b>Description: </b> During the experiment, student knows which value is greatest among three numbers before excution of the program. In simulator when user inputs the value which is to be define and the value is inncorrect the virtual simulator will display an alert message. If input values will be correct then code will be execute. After execution of the program user expects some predefined result.
